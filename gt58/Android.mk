...
ifeq ($(TARGET_BOARD_PLATFORM),gt58)
...
$(CMN_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	...
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf  /vendor/odm/firmware/image/$(notdir $@) $@
...
$(KM_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	...
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf  /vendor/odm/firmware/image/keymaste$(suffix $@) $@
...
$(MODEM_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	...
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf  /vendor/odm/modem/image/$(notdir $@) $@
