...
BOARD_SUPER_PARTITION_CACHE_DEVICE_SIZE := 209715200 # 200M
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE := 3145728000 # 3G
BOARD_SUPER_PARTITION_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_CACHE_DEVICE_SIZE) + $(BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE) )
